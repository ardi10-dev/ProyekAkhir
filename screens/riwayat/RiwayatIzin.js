...
function RiwayatIzin({ route }) {
        ...
        const fetchRiwayatIzin = async () => {
            try {
                ...
                if (data !== null) {
                    ...
                    const apiUrl = `https://hc.baktitimah.co.id/pegawaian/api/API_Izin/getIzin?id_pegawai=${idPegawai}`;
    ...
    function renderRiwayatIzin({ item }) {
        const nama = item[3] || ''; // Contoh: nama ada di indeks 3, default ke string kosong jika undefined
        const nip = item[2] || ''; // Contoh: nip ada di indeks 2, default ke string kosong jika undefined
        const ket = item[1] || ''; // Contoh: keterangan ada di indeks 8, default ke string kosong jika undefined
        const jenisIzin = item[8] || ''; // Contoh: jenis izin ada di indeks 7, default ke string kosong jika undefined
        const tanggal = item[4] || ''; // Contoh: jenis izin ada di indeks 7, default ke string kosong jika undefined
